...
func main() {
	...
	output_pixelsR = make([]uint16, width*height*SCALE_FACTOR*SCALE_FACTOR)
	output_pixelsG = make([]uint16, width*height*SCALE_FACTOR*SCALE_FACTOR)
	output_pixelsB = make([]uint16, width*height*SCALE_FACTOR*SCALE_FACTOR)
	output_pixelsA = make([]uint16, width*height*SCALE_FACTOR*SCALE_FACTOR)
	...
	utils.Write_image_data(OUTPUT_FILE, output_pixelsR, output_pixelsG, output_pixelsB, output_pixelsA, width*SCALE_FACTOR, height*SCALE_FACTOR)
